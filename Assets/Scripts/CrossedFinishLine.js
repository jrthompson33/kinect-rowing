...
function OnGUI()
{
	...
	if(isFinishLineCrossed)
	{
	   GUI.skin.label.fontSize  = 50;
 	   GUI.Label(Rect((Screen.width - 1100)/2 ,Screen.height/2 ,Screen.width,Screen.height/2), "Congratulations, you won the game in " + Mathf.Floor(totalTime) + " seconds!!!");	
	} 
